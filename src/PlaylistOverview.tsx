...
function PlaylistOverview({selectedPlaylistId, setSelectedPlaylistId}: IProps) {
          ...
          <div className="p-3 mb-3" onClick={() => setSelectedPlaylistId(playlist.id)}>  
            <div className="w-56 rounded overflow-hidden shadow-lg">
              ...
              <div className="px-6 pb-1">
                <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-xs font-semibold text-gray-700 mr-2 mb-2">Tracks: {playlist.tracks.total}</span>
              </div>
            </div>
          </div>
        ))}
